...
public class HttpTestUtil {
    ...
    public static void main(String[] args) throws IOException{
        HttpTestUtil htu = new HttpTestUtil();
...
//            HttpClientResult rs = htu.doPost(URL_POST2,body);
    ...
    /**
     * 发送get请求；不带请求头和请求参数
     * 外部封装 https://github.com/JourWon/httpclientutil/blob/master/src/main/java/com/jourwon/httpclient/pojo/HttpClientResult.java
     * @param url 请求地址
     * @return
     * @throws Exception
     */
